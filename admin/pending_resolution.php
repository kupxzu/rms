                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($row['attachment']): ?>
                                            <a href="../uploads/resolutions/<?php echo $row['attachment']; ?>" target="_blank">View</a>
                                        <?php else: ?>
                                            None
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <a href="function/approve_reject_resolution.php?type=resolution&id=<?php echo $row['id']; ?>&action=approve" 
                                           class="btn btn-success btn-sm">Approve</a>
                                        <button class="btn btn-danger btn-sm reject-item" 
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="function/reject_resolution.php" method="POST">
