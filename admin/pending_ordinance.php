        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ordinances Awaiting Approval</h3>
                </div>
                <div class="card-body">
        ...
        <form action="function/reject_item.php" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Reject Ordinance</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="item_id" id="reject_item_id">
                    <input type="hidden" name="item_type" value="ordinance">
