...
// Fetch Ordinance and Resolution files only (exclude Events)
$query = "SELECT f.id, f.title, f.description, f.file_path, f.file_type, f.uploaded_at,
          ...
          WHERE (p.department_id = ?) AND f.file_type IN ('Ordinance', 'Resolution') 
          GROUP BY f.id 
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header bg-primary text-white">
                  <h3 class="card-title">Ordinance & Resolution Files</h3>
                </div>
                <div class="card-body">
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="badge badge-<?php
                                if ($row['file_type'] == 'Ordinance') echo 'success';
                                elseif ($row['file_type'] == 'Resolution') echo 'warning';
                              ?>">
                  ...
                  <?php else: ?>
                    <p class="text-muted">No files available for your department.</p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
