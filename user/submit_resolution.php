...
<head>
  ...
  <title>Compose Resolutions</title>
                ...
                <div class="card-body">
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="tab-pane" id="timeline">
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php if ($row['attachment']): ?>
                                    <a class="btn btn-info btn-sm" href="../uploads/resolution/<?= htmlspecialchars($row['attachment']) ?>" target="_blank"><i class="fas fa-eye"></i>View File</a>
                                  <?php else: ?>
                                    No Attachment
                                  <?php endif; ?>
                                </td>
                      ...
                      <?php else: ?>
                        <p>No pending resolutions found.</p>
                      <?php endif; ?>
                    </div>
                  </div>
                </div> 
